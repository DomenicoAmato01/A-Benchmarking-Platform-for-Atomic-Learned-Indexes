...
/*
 * STX B+ HistogramTree Template Classes v0.9
...
public:
    // *** Static Constant Options and Values of the B+ HistogramTree
    ...
    static const unsigned int minleafslots = leafslotmax - 1;

    /// Computed B+ tree parameter: The minimum number of key slots used
    /// in an inner node. If fewer slots are used, the inner node will be
    /// merged or slots shifted from it's siblings.
    static const unsigned int mininnerslots = innerslotmax - 1;
...
private:
    // *** HistogramTree Object Data Members
...
public:
    // *** Fast Destruction of the B+ HistogramTree
...
private:
    // *** B+ HistogramTree Node Binary Search Functions
...
public:
    // *** Standard Access Functions Querying the HistogramTree by Descending to a Leaf

    size_t height() const
    {
        return m_root->level + 1;
    }
...
public:
    // *** B+ HistogramTree Object Comparison Functions
...
public:
    ...
    // *** Bulk Loader - Construct HistogramTree from Sorted Sequence
...
public:
    ...
    /// currently not implemented by the B+ HistogramTree.
...
public:
    // *** Verification of B+ HistogramTree Invariants
