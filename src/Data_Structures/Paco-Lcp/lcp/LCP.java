...
public class LCP {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args_len > 0) {
            ...
            lcpData = new LcpDataStructure(dataset, 0);
            hashFinish = System.nanoTime();
            hashElapsedTime = hashFinish - hashStart;

            hashTimeString.append(lcpData.getBitDimension() / 8.0);
            hashTimeString.append(",");
            ...
            System.out.println(hashTimeString.toString());
            ...
            if (params.containsKey("query")) {
                ...
                for (int i = 0; i < queryDataset.size(); i++) {
                    long q = queryDataset.get(i);
                    predStart = System.nanoTime();
                    long predecessorIndex = lcpData.getPredecessorIndex(q);
                ...
                int wrong = queryDataset.size() - correct;
                ...
                predTimeString.append("\n");
                System.out.println(predTimeString);
